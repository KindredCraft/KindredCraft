...
public class GuiBasicElementalCrystalizationChamber extends ElementsKindredCraft.ModElement {
	public static int GUIID = 6;
	public static HashMap guistate = new HashMap();
	public GuiBasicElementalCrystalizationChamber(ElementsKindredCraft instance) {
		super(instance, 369);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 71, 57) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			}));
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 98, 57) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("kindredcraft:textures/basicelementalcrystalizationchamber.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("kindredcraft:textures/arrowdownsmall.png"));
			this.drawTexturedModalRect(this.guiLeft + 74, this.guiTop + 11, 0, 0, 256, 256);
			this.mc.renderEngine.bindTexture(new ResourceLocation("kindredcraft:textures/arrowdownsmall1.png"));
			this.drawTexturedModalRect(this.guiLeft + 47, this.guiTop + 11, 0, 0, 256, 256);
		}
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("ECC", 7, 11, -1);
			this.fontRenderer.drawString("Inventory", 7, 65, -1);
			this.fontRenderer.drawString("x9", 115, 11, -1);
		}
