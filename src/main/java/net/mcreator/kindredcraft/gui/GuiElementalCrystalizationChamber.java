...
public class GuiElementalCrystalizationChamber extends ElementsKindredCraft.ModElement {
	public static int GUIID = 4;
	public static HashMap guistate = new HashMap();
	public GuiElementalCrystalizationChamber(ElementsKindredCraft instance) {
		super(instance, 365);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("kindredcraft:textures/elementalcrystalizationchamber.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.drawTexturedModalRect(this.guiLeft + 55, this.guiTop + 11, 0, 0, 256, 256);
		}
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			...
			this.fontRenderer.drawString("x9", 100, 11, -1);
		}
