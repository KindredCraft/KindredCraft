...
public class MCreatorTestGui extends Elementskindredcraft.ModElement {
	public static int GUIID = 2;
	public static HashMap guiinventory = new HashMap();
	public static IInventory iwow;
	public static IInventory inherited;

	public MCreatorTestGui(Elementskindredcraft instance) {
		super(instance, 380);
	}
	...
	public static class GuiContainerMod extends Container {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			if (ent instanceof MCreatorTestBlockPleaseIgnore.TileEntityCustom)
				inherited = (IInventory) ent;
			else
				inherited = new InventoryBasic("", true, 9);
			iwow = new InventoryBasic("iwow", true, 9);
			guiinventory.put("iwow", iwow);
			this.addSlotToContainer(new Slot(iwow, 0, 13, 25) {
			});
			this.addSlotToContainer(new Slot(iwow, 1, 138, 24) {
				@Override
		...
		public void onContainerClosed(EntityPlayer playerIn) {
			...
			InventoryHelper.dropInventoryItems(world, new BlockPos(x, y, z), iwow);
		}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("kindredcraft:textures/testgui.png");
