...
public class BlockAdvancedElementalCrystallizationChamber extends ElementsKindredCraft.ModElement {
	@GameRegistry.ObjectHolder("kindredcraft:advancedelementalcrystallizationchamber")
	public static final Block block = null;
	public BlockAdvancedElementalCrystallizationChamber(ElementsKindredCraft instance) {
		super(instance, 46);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("advancedelementalcrystallizationchamber"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("kindredcraft:advancedelementalcrystallizationchamber", "inventory"));
	}
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return "container.advancedelementalcrystallizationchamber";
		}
