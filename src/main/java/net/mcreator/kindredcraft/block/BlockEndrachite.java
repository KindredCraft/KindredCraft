...
public class BlockEndrachite extends ElementsKindredCraft.ModElement {
	@GameRegistry.ObjectHolder("kindredcraft:endrachite")
	public static final Block block = null;
	public BlockEndrachite(ElementsKindredCraft instance) {
		super(instance, 54);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("endrachite"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("kindredcraft:endrachite", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemDustMagichite.block, (int) (9)));
		}
