...
import net.mcreator.kindredcraft.procedure.ProcedureElementalCentrifugePro;
import net.mcreator.kindredcraft.procedure.ProcedureElementalCentrifugeOnBlockRightClicked;
...
public class BlockElementalCentrifuge extends ElementsKindredCraft.ModElement {
	@GameRegistry.ObjectHolder("kindredcraft:elementalcentrifuge")
	public static final Block block = null;
	public BlockElementalCentrifuge(ElementsKindredCraft instance) {
		super(instance, 41);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("elementalcentrifuge"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("kindredcraft:elementalcentrifuge", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
			...
			int z = pos.getZ();
			{
				...
				ProcedureElementalCentrifugePro.executeProcedure($_dependencies);
			}
			world.scheduleUpdate(new BlockPos(x, y, z), this, this.tickRate(world));
		}
		...
		public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing direction,
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureElementalCentrifugeOnBlockRightClicked.executeProcedure($_dependencies);
			}
			return true;
		}
	}
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return "container.elementalcentrifuge";
		}
