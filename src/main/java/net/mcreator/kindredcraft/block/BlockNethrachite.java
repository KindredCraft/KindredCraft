...
public class BlockNethrachite extends ElementsKindredCraft.ModElement {
	@GameRegistry.ObjectHolder("kindredcraft:nethrachite")
	public static final Block block = null;
	public BlockNethrachite(ElementsKindredCraft instance) {
		super(instance, 55);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("nethrachite"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("kindredcraft:nethrachite", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("nethrachite");
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemDustMagichite.block, (int) (7)));
		}
