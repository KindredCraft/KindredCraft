...
public class MCreatorElementalCrystalizationChamber extends Elementskindredcraft.ModElement {
	...
	public static class GuiContainerMod extends Container {
		...
		public void onContainerClosed(EntityPlayer playerIn) {
			...
			InventoryHelper.dropInventoryItems(world, new BlockPos(x, y, z), ECCOut);
		}
